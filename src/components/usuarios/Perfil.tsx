...
import ObrasEnProcesoUsuario from "./ObrasEnProcesoUsuario";
import MisObras from "./MisObras";
import ObrasTerminadasUsuario from "./ObrasTerminadasUsuario";

const menuItems = [
  {
    title: "Obras",
    subItems: ["Mis obras", "Obras en proceso", "Obras terminadas"],
  },
  {
    title: "Pagos",
...
const Perfil = () => {
  ...
  useEffect(() => {
    setOpenTab("Obras");
    handleSubItemClick("Mis obras");
  }, []);
  const handleSubItemClick = (componentName: string) => {
    setOpenSubTab(componentName);
    switch (componentName) {
      case "Obras en proceso":
        setSelectedComponent(<ObrasEnProcesoUsuario />);
        break;
      case "Mis obras":
        setSelectedComponent(<MisObras />);
        break;
      case "Obras terminadas":
        setSelectedComponent(<ObrasTerminadasUsuario />);
        break;
      default:
